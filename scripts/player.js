...
<div class="player">
  ...
  <div class="player__rsvp">
    <form id="rsvp_form" name="rsvp_form">
      ...
      <input type="text" pattern="[0-9a-zA-Z .,#'-]+" name="address" id="rsvp_address" placeholder="ADDRESS">
...
<div class="player">
  ...
  <div class="player__rsvp">
    <form id="rsvp_form" name="rsvp_form">
      ...
      <input type="text" pattern="[0-9a-zA-Z .,#'-]+" name="address" id="rsvp_address" placeholder="DIRECCIÓN">
